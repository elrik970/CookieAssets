...
namespace PlayerStateMachine {
    [CreateAssetMenu(fileName = "New WalkState", menuName = "States/Player/LeftWalkState")]
    public class WalkLeftState : PlayerState<Player>
    {
        ...
        public override void Init(Player parent) {
            ...
            movement.Normal.RunLeftRelease.performed += OnWalkRelease;
